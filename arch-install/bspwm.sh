...
sudo pacman -S --noconfirm xorg light-locker lightdm bspwm sxhkd firefox picom nitrogen lxappearance dmenu rofi thunar arandr xarchiver viewnior ncdu alsa-utils pulseaudio pulseaudio-alsa pavucontrol arc-gtk-theme arc-icon-theme noto-fonts  ttf-roboto ttf-ubuntu-font-dr ttf-hack ttf-fira-code  ttf-jetbrains-mono ttf-font-awesome awesome-terminal-fonts archlinux-wallpaper playerctl scrot dunst pacman-contrib
