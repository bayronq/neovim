...
pacman -S --noconfirm grub networkmanager network-manager-applet dialog wpa_supplicant mtools dosfstools reflector base-devel linux-headers nfs-utils inetutils bluez bluez-utils openssh rsync reflector os-prober ntfs-3g terminus-font
